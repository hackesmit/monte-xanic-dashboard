# Monte Xanic Dashboard -- Codex Instructions
...
Developed in a single console — one session plans, builds, tests, and ships. See [docs/Development-Rules.md](docs/Development-Rules.md).
